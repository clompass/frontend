        ...
        <Navbar bg="dark" variant="dark" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    <Nav.Link as="a" href="https://outlook.com/lilydaleheights.vic.edu.au" target="_blank" rel="noopener" aria-hidden="true">Emails <i className="fa fa-external-link" style={{"fontSize": "75%"}} aria-hidden="true"></i></Nav.Link>
